...
import loadWorldData from './assets/loadWorld.js';
...
document.addEventListener("DOMContentLoaded", async () => {
    try {
        ...
        // button text
        buttonEle.textContent = `start your journey`;
        // set button id
        buttonEle.setAttribute("id", `start-game`);
...
async function buttonClick(e) {
            ...
            try {
                ...
                // json worldData
                const levelNumber = 1;
                worldData = await loadWorldData(levelNumber); // defaults to always return file "1.json", change in ./assets/loadWorld.js.
